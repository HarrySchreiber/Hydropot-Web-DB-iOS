...
func filterList(filteredValues: [(Bool,Bool,Bool)], displayedList: inout [String], plants: Plants, searchedList: [String], urlList: inout [String]) {
    ...
    for plant in plants.plantList {
        ...
        let lowMoisture = (filteredValues[0].0 && plant.idealMoistureHigh <= moistureTuple.0 && plant.idealMoistureHigh != -1000)
        ...
        let lowLight = (filteredValues[1].0 && plant.idealLightHigh <= lightTuple.0 && plant.idealMoistureHigh != -1000)
        ...
        let lowTemp = (filteredValues[2].0 && plant.idealTempHigh <= tempTuple.0 && plant.idealMoistureHigh != -1000)
